...
public class Persistencia {
    ...
    public MovieModel getMovie(String imdbId) {
        SQLiteDatabase db = Bancodedados.getDB(MainActivity.getCtx());
        db.beginTransaction();

        ArrayList<String> params = new ArrayList<>();

        String select = "select * from movies where species_id = ?";
        params.add(imdbId);
    ...
    public String updateMovie(String imdbId) {
        SQLiteDatabase db = Bancodedados.getDB(MainActivity.getCtx());
        db.beginTransaction();
    ...
    public void setMovie(MovieModel movie) {
        ...
        try {
            if(movie != null) {
                ...
                values.put("Adicionado", movie.getAdicionado());
